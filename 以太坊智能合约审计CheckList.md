...
# 以太坊智能合约审计CheckList 目录
   ...
   * [5、编码问题隐患](#5编码问题隐患)
      ...
      * [(10) 条件竞争问题](#10-条件竞争问题)
         * [真实世界事件](#真实世界事件-6)
      * [(11) 未初始化的储存指针](#11-未初始化的储存指)		
      * [(12) 「输入假名」问题](#11-「输入假名-问题)
         * [真实世界事件](#真实世界事件-7)  
...
- [## zkSNARK 合约「输入假名」漏洞致众多混币项目爆雷]([https://mp.weixin.qq.com/s/IJc5HyA_VEEl3pd76lNZcw](https://mp.weixin.qq.com/s/IJc5HyA_VEEl3pd76lNZcw))
